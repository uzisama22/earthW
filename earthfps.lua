...
Team Based button =  O
Speed = Y
Ballistics = [ for up ] for down
Close the gui = Ctrl + H
when execute press o on keyboard for fps gui to work
]]--
pcall(function()
...
local Aim_Assist = false ; Aim_Assist_Key = {Enum.KeyCode.RightControl , "p"}
...
print("Checking HWID Authentication")
